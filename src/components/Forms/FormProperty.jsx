...
const FormProperty = () => {
  ...
  const handleOnlyNumber = (e) => {
    ...
    if (numericValue.length > 2) {
      e.target.value = numericValue.slice(0, 30);
    } else {
    ...
    <div>
      <form className="row g-3">
        ...
        <div className="col-lg-2 col-sm-12">
          <label htmlFor="inputSelectMatricula" className="form-label centered">
            Tem Matrícula?
          </label>
          <select
        ...
        <div className="col-12">
          <label htmlFor="propertyName" className="form-label centered">
            Nome da propriedade
          </label>
          <input type="text" className="form-control" id="inputPropertyName" />
        </div>
        <div className="col-lg-7 col-sm-12">
          <label htmlFor="inputTexturaSolo" className="form-label">
            Textura predominante do solo na área explorada
          </label>
        ...
        <div className="col-lg-4 col-sm-12">
          <label htmlFor="inputArea" className="form-label">
            Área explorada economicamente (hectares)
          </label>
          <input
            type="text"
            className="form-control"
        ...
        <div className="col-lg-3 col-sm-12">
          <label htmlFor="inputContract" className="form-label">
            Tipo de contrato
          </label>
        ...
        <div className="col-lg-5 col-sm-12">
          <label htmlFor="inputProducer" className="form-label">
            Proprietário
          </label>
        ...
        <div className="col-lg-6 col-sm-12">
          <label htmlFor="inputAddress" className="form-label">
            Tamanho da área contratada (hectares)
          </label>
          <input
            type="text"
            className="form-control"
