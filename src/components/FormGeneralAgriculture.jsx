      ...
      <form className="row g-3">
        ...
        <div className="col-lg-8 col-sm-12">
          <label htmlFor="inputText" className="form-label centered">
            Qual cultura - Agricultura Geral?
          </label>
        ...
        <div className="row g-3 container-2">
          ...
          <div className="col-12 centered">
            <h6>
              <strong>Dados da Safra Prevista</strong>
            </h6>
          </div>
        ...
        <div className="row g-3 container-3">
          <div className="text-center">
            <div className="col-8 text-center">
              <h6>Ano predominante da colheita:</h6>
            </div>
            <div className="col-4">
              <label
                htmlFor="inputText"
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6>Área de plantio da cultura (hectares):</h6>
            </div>
            <div className="col-4">
              <label
                htmlFor="inputText"
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6>
                Produtividade estimada para a safra (kg/ha ou unidade/ha):
              </h6>
            </div>
            <div className="col-4">
              <label
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6>Contrato de pré-venda para mais de 50% da produção?</h6>
            </div>
            <label htmlFor="inputTexturaSolo" className="form-label"></label>
            <select className="form-select input" id="inputTexturaSolo">
              <option value=""></option>
