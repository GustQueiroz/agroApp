    ...
    <div>
      <form className="row g-3">
        ...
        <div className="col-12">
          <label htmlFor="inputCivilState" className="form-label centered">
            Qual cultura Perene?
          </label>
          <select className="form-select input centered" id="inputCivilState">
            ...
            <option value="laranja-para-industria">
        ...
        <div className="col-12"></div>
        <div className="col-12">
          <label htmlFor="inputDate" className="form-label centered">
            Histórico de safras anteriores - Área Plantada
          </label>
        ...
        <div className="col-12">
          <label htmlFor="inputDate" className="form-label centered">
            Histórico de safras anteriores - Área Renovada
          </label>
          <div className="row centered">
            <div className="col-lg-3 col-sm-12">
              <label htmlFor="inputDate" className="form-label centered">
        ...
        <div className="row g-3 container-2">
          ...
          <div className="col-12">
            <label htmlFor="inputDate" className="form-label centered">
              <h4>Histórico de safras anteriores - Área Renovada</h4>
            </label>
          </div>
          <div className="col-12"></div>
          <div className="text-center">
            <div className="col-8 text-center">
              <h6 className="text-center">Ano de previsão da colheita:</h6>
            </div>
            <div className="col-4">
              <label
                htmlFor="inputText"
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6 className="text-center">
                Área de plantio atual da cultura (hectares):
              </h6>
            </div>
            <div className="col-4">
              <label
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6 className="text-center">
                Área a ser renovada na safra prevista:
              </h6>
            </div>
            <div className="col-4">
              <label
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6 className="text-center">
                Percentual da área total da cultura com irrigação:
              </h6>
            </div>
            <div className="col-4">
              <label
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6>Nivel tecnológico adotado para esta cultura:</h6>
            </div>
        ...
        <div className="col-lg-4 col-sm-12">
          ...
          <label htmlFor="inputText" className="form-label centered invisible">
            a
          </label>
          <label htmlFor="inputText" className="form-label centered">
        ...
        <div className="col-lg-8 col-sm-12">
          ...
          <div className="row centered">
            ...
            <div className="col-5">
              <label htmlFor="inputText" className="form-label centered">
                Custo Renovação Safra Prevista
              </label>
              <CurrencyInput
                id="inputText"
                name="inputText"
