    ...
    <div>
      <form className="row g-3">
        ...
        <div className="col-lg-4 col-sm-12">
          ...
          <label className="form-label centered invisible">
            Qual Cultura Anual
          </label>
        ...
        <div className="row g-3 container-2">
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6 className="text-center">
                Área de plantio da Cultura na safra prevista (hectares):
              </h6>
            </div>
            <div className="col-4">
              <label
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6>Percentual da produção utilizada para consumo próprio:</h6>
            </div>
            <div className="col-4">
              <label
                htmlFor="inputText"
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6>Percentual da produção com armazenamento próprio:</h6>
            </div>
            <div className="col-4">
              <label
                htmlFor="inputText"
          ...
          <div className="text-center">
            <div className="col-8 text-center">
              <h6>Produtividade média estimada para a safra (kg/ha):</h6>
            </div>
            <div className="col-4">
              <label
                htmlFor="inputText"
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-sm-12">
            <label
              htmlFor="inputCivilState"
              className="form-label centered invisible"
            >
              a
            </label>
            <label htmlFor="inputCivilState" className="form-label centered">
